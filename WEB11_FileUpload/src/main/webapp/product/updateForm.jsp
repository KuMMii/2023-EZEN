	...
	<form action="product.do?command=update" method="post" enctype="multipart/form-data">
		...
		<table>
			<tr>
				...
				<td>
					<table border="1">
						<tr><th style="width:80px">상품평</th><td><input type="text" name="name" value="${product.name}"
						size="80"></td></tr>
						<tr><th>가 격</th><td><input type="text" name="price" value="${product.price}"> 원</td></tr>
						<tr><th>사 진</th><td><input type="file" name="pictureurl"><br>
						(주의사항 : 이미지를 변경하고자 할 때만 선택하세요)</td></tr>
						<tr><th>설 명</th><td><textarea cols="90" rows="10" name="description">
