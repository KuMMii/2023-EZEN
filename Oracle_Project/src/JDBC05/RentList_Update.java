...
class UpdateForm extends JFrame implements ActionListener{
	...
	numseq = new JTextField(10);	rentdate=new JTextField();
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "조회" :
			...
			if(rdto ==null) {
				JOptionPane.showMessageDialog(null, "No Book in the List");
				return;
			}else {
				//getRent를 RentDao에 생성하고, 리턴받은 내용을 각 JTextField에 입력하기
		...
		case "수정" :
			...
			if(result==1) {
				...
				numseq.setText("");rentdate.setText("");bnum.setText(""); mnum.setText(""); discount.setText("");
			}
			else {
